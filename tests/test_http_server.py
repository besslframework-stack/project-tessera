...
class TestMemory:
    ...
    def test_recall(self, mock_recall):
        ...
        assert resp.status_code == 200
        mock_recall.assert_called_once_with("database", 3, since=None, until=None, category=None, include_superseded=False, project=None)
    ...
    def test_recall_with_filters(self, mock_recall):
        ...
        mock_recall.assert_called_once_with(
            ...
            include_superseded=False, project=None,
        )
